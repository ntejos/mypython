...
#
setup_keywords['name'] = 'mypython'
setup_keywords['description'] = 'MUSE datacube handling modules'
setup_keywords['author'] = 'Michelle Fumagalli'
setup_keywords['author_email'] = 'michelle.fumagalli@durham.ac.uk'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/mifumagalli/mypython/tree/master/ifu'
#
...
if os.path.exists('README_muse_pipeline.md'):
    with open('README_muse_pipeline.md') as readme:
